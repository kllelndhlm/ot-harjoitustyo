...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortin_saldo_ei_alita_nollaa(self):
        self.kortti.lataa_rahaa(-5)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_syo_edullisesti_kun_saldo_kaksi_viisikymmentae(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_kun_saldo_neljae(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.lataa_rahaa(2.0)
        self.kortti.syo_maukkaasti()
        self.assertEqual("Kortilla on rahaa 0.0 euroa", str(self.kortti))
